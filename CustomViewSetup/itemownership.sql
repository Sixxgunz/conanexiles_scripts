...
INSERT INTO `cust_item_xref` (template_id,name,type) VALUES (10001,'Stone','ingredient'),
 ...
 (41033,'Torch','weapon'),
 (51001,'Stone Pick','tool'),
 (51002,'Iron Pick','tool'),
 (51003,'Steel Pick','tool'),
 (51011,'Stone Hatchet','tool'),
 (51012,'Iron Hatchet','tool'),
 (51013,'Steel Hatchet','tool'),
 (51021,'Pickaxe','tool'),
 (51031,'Repair Hammer','tool'),
 ...
 (51014,'Hardened Steel Hatchet','tool'),
 (51015,'Star Metal Hatchet','tool'),
 (51022,'Hardened Steel Pick','tool'),
 (51023,'Star Metal Pick','tool'),
 (51040,'Steel Sickle','weapon'),
 (51041,'Hardened Steel Sickle','weapon'),
 (51042,'Star Metal Sickle','weapon'),
 (51066,'Telith''s Lament','weapon'),
 (51067,'Hoar-Frost Hatchet','tool'),
 ...
 (51977,'Black Ice Pick','tool'),
 (51978,'Acheronian Pick','tool'),
 ...
 (11073,'Skeleton Key','material');

DROP VIEW IF EXISTS `Item_Ownership_Info`;
CREATE VIEW `Item_Ownership_Info` AS 
select
  player_guild_name,
  ItemName,
...
/* pull script for specific items so as not to load ALL items and lag out ur workstation */
-- select * from item_ownership_info where itemname like ('wood');

/* delete any and all type of items just add correct item id you want gone */
-- delete from item_inventory where template_id in ('11073');